        ...
        <aside className="flex flex-col bg-gray-800 min-h-screen">
            ...
            <main className="flex flex-1">
                <SidebarHome
                    ...
                    textColorLogOut="text-orange-500"
                    ...
                    BgColorLogOut="bg-gray-400"
                />
                <div className="flex flex-col my-10 md:mt-32 ms:mx-10 ms:mt-28">
